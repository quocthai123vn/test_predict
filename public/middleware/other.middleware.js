...
exports.checkTestKeyMiddleware = exports.checkPageMiddleware = void 0;
...
const checkTestKeyMiddleware = (req, res, next) => {
    const testKey = req.query.testKey;
    if (!testKey) {
        return res.status(400).json({ message: status_constant_1.STATUS_CODE[400] });
    }
    if (testKey !== environment_constant_1.TEST_KEY) {
        return res.status(400).json({ message: status_constant_1.STATUS_CODE[400] });
    }
    return next();
};
exports.checkTestKeyMiddleware = checkTestKeyMiddleware;
